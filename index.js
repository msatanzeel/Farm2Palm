...
// Importing the objects from seeds folder
...
// Env will contain all sensitive info
const dbUrl = 'mongodb+srv://tanzuu-46:abcd%21%40%23%24@cluster0.lkwvn.mongodb.net/myFirstDatabase?retryWrites=true&w=majority' || 'mongodb://localhost:27017/farm2palm';
...
app.use((req,res,next)=>{
   ...
   if(!['/login','/logout','/cart'].includes(req.originalUrl)){
    //    Storing the url except the above three mentioned , which will be used to redirect
    // in case if the user is not logged in and tries to buy
